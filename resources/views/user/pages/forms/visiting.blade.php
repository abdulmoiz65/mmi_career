...
<h4 class="mt-4">Visiting Faculty Application Form</h4>
    ...
    <div class="mb-3">
        ...
        @foreach(['business' => 'Faculty of Business Administration', 'computing' => 'Faculty of Computing', 'life_sciences' => 'Faculty of Life Sciences'] as $value => $label)
            <div class="form-check">
                <input class="form-check-input" type="radio" name="dept" value="{{ $value }}"
                       {{ old('dept') == $value ? 'checked' : '' }} required>
                <label class="form-check-label">{{ $label }}</label>
            </div>
        @endforeach
    </div>
...
<div class="form-section">
    ...
    <div class="row g-3">
        <div class="col-md-6">
            <div class="mb-3">
                <label class="form-label">Years of Experience in Academia<span class="text-danger">*</span></label>
        ...
        <div class="col-md-6">
            <div class="mb-3">
                <label class="form-label">Years of Experience in Industry<span class="text-danger">*</span></label>
